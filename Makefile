...
FILES = src/window.c src/main.c src/input.c src/actor.c src/graphics.c src/glad.c src/utils.c src/camera.c src/time.c src/gamestate.c src/network.c src/debug.c -isystem glad.c
all:
